...
import { Segment, Header, Comment, Button, Label } from "semantic-ui-react";
  ...
  return (
    <>
      ...
      <Segment attached clearing>
        ...
        {!isLoggedIn && (
          <>
            <Label content="Please login to add comments" />
            <Button
          ...
          {commentStore.comments.map((comment) => (
            <Comment key={comment.id}>
              ...
              <Comment.Content>
                ...
                <Comment.Metadata>
                  <div>
                    {formatDistanceToNow(comment.createdAt.toISOString())} ago
                  </div>
                </Comment.Metadata>
